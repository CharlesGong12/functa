...
class LatentVector(nn.Layer):
    ...
    """
    def __init__(self, latent_dim: int, batch_size: int = 4, latent_init_scale: float = 0.05):
        """Constructor.
...
class LatentToModulation(nn.Layer):
    ...
    def __init__(self,
        ...
        Args:
            ...
            There is only one single value, indicating how many gamma and beta values per layer.
...
class MetaSGDLrs(nn.Layer):
    ...
    def __init__(self,
               num_lrs: int,
               lrs_init_range: Tuple[float, float] = (1e-7, 1e-4),
               lrs_clip_range: Tuple[float, float] = (-5., 5.)):    #(-5., 5.)
        """Constructor.
        ...
        Args:
            ...
            uniformly sampled.
            lrs_clip_range: Learning Rate clipping. Range at which to clip learning rates. 
            Default value will effectively avoid any clipping, but typically learning rates should
